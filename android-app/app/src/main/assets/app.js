...
renderAll();
const BUNDLED_PRODUCT_VERSION="2026-08-13-product-list-12-v1";
if(localStorage.getItem("suh-bundled-product-version")!==BUNDLED_PRODUCT_VERSION){loadBundledProducts(false).then(stats=>{localStorage.setItem("suh-bundled-product-version",BUNDLED_PRODUCT_VERSION);renderAll();if(stats&&(stats.added||stats.updated))toast(`Product SKU list loaded: ${stats.added} new, ${stats.updated} updated`)})}
